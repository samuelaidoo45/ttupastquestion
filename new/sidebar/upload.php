...
if (isset($_POST['upload'])){ 
  ...
  $folder = "./pdf/" . $filename;
      ...
      $INSERT = "INSERT INTO user (title,code,lecturer,file,year)values(?,?,?,?,?)";
...
$stmt->bind_param("sssss",$title,$code,$lecturer,$year, $filename);
  $stmt->execute();
  $conn->close();
...
<h5>Dashboard/Upload Questions</h5>


<form action="" method="POST">
<div class="container-fluid">
  <h5 style="color:royalblue;">Upload Questions</h5>
  <div class="row">
    ...
    <div class="w-100"></div>   
      ...
      <div class="col-3"><br> <button class="btn btn-primary btn-block" name="upload">Upload</button>
  </div>
</div>
</form>
